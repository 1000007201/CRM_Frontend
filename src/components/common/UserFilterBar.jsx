...
// ── Avatar palette (matches Pipeline.jsx) ─────────────────────────────────────
const PALETTE = [
...
export default function UserFilterBar() {
  const { user } = useAuth();
  const { selectedIds, toggleTL, toggleMember, clearAll, tls, members, team } = useUserFilter();
    ...
    <div style={{
      ...
      {hasSelection && (
        <button onClick={clearAll} style={{
          ...
          borderRadius: 3, border: "1px solid var(--border2)",
